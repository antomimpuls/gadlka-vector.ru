(() => {
  ...
  const injectStyles = () => {
    ...
    style.textContent = `
      .admin-panel{position:fixed;bottom:24px;left:24px;width:320px;max-width:92vw;background:rgba(45,45,45,0.94);color:#f5f5f5;border:1px solid rgba(107,114,128,0.4);border-radius:16px;padding:18px;box-shadow:0 18px 38px rgba(0,0,0,0.4);z-index:9999;font-family:'Inter','Segoe UI',sans-serif;backdrop-filter:blur(12px);}
      ...
      .admin-panel__input{flex:1 1 140px;padding:10px 12px;border-radius:10px;border:1px solid rgba(107,114,128,0.5);background:rgba(20,20,20,0.85);color:#f5f5f5;font-size:14px;}
      .admin-panel__btn{padding:10px 14px;border-radius:10px;border:none;background:linear-gradient(135deg,#6b7280,#4b5563);color:#f9fafb;font-weight:600;cursor:pointer;transition:transform .15s ease, box-shadow .15s ease;}
      .admin-panel__btn:hover{transform:translateY(-1px);box-shadow:0 12px 20px rgba(107,114,128,0.35);}
      .admin-panel__btn--ghost{background:rgba(107,114,128,0.16);color:#f5f5f5;}
      .admin-panel__btn--ghost:hover{box-shadow:0 12px 20px rgba(107,114,128,0.25);}
      .admin-panel__hint{font-size:13px;color:#b3b3b3;margin:0;}
      .admin-panel__status{font-size:13px;color:#d1d5db;margin:0;}
      .admin-panel__section--meta{font-size:13px;color:#b3b3b3;}
      .admin-panel__section--meta button{width:100%;}
      .admin-wa-target{outline:1px dashed rgba(107,114,128,0.6);outline-offset:4px;position:relative;}
      .admin-wa-target::after{content:'WA';position:absolute;top:-10px;right:-10px;font-size:11px;background:rgba(107,114,128,0.85);color:#f9fafb;padding:2px 6px;border-radius:999px;}
